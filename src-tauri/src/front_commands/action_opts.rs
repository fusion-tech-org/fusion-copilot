...
use crate::Counter;
use FusionTech::schema::{
  notes::dsl::*,
  ziwei_apps::dsl::{id as aid, *},
};
...
#[tauri::command]
pub fn create_ziwei_app(name: &str, new_app_id: &str, version: &str) -> usize {
...
pub fn del_app_by_id(app_key: i32) -> usize {
  ...
  diesel::delete(ziwei_apps.filter(aid.eq(&app_key)))
    .execute(conn)
